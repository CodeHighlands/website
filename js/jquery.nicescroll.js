...
*/
   ...
   if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
    ...
    /*Custom stuff because its not working*/
    $('html').prepend("<div class='nicescrollrail'></div>");
    var rail = $('div.nicescrollrail');
...
*/
 ...
 mplex(
 NiceScrollArray.prototype, ['show', 'hide', 'toggle', 'onResize', 'resize', 'remove', 'stop', 'doScrollPos'], function(e, n) {
  e[n] = function() {
   var args = arguments;
   return this.each(function() {
